  ...
  return (
    <section className="page-section" style={{ maxWidth: '400px', margin: '40px auto' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: '20px' }}>
        {isLogin ? (
          <p>Chưa có tài khoản? <span style={{ color: '#2563eb', cursor: 'pointer', fontWeight: 'bold' }} onClick={() => setIsLogin(false)}>Đăng ký ngay</span></p>
        ) : (
          <p>Đã có tài khoản? <span style={{ color: '#2563eb', cursor: 'pointer', fontWeight: 'bold' }} onClick={() => setIsLogin(true)}>Đăng nhập</span></p>
        )}
      </div>
    </section>
  );
